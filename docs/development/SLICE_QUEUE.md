...
Base verificada: `origin/development` `a0bf91c6`, 2026-09-07.
...
|---|---|---|
| Cierre de QA Labs | Tests UI/Wizard, browser y pruebas reales acotadas | #182–#196 integrados; no rehacer sus funciones. Diferenciar plano y attemptId, móvil y GPU |
